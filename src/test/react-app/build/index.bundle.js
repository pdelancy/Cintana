...
var _baseGetTag = __webpack_require__(55);

var _baseGetTag2 = _interopRequireDefault(_baseGetTag);

var _getPrototype = __webpack_require__(60);

var _getPrototype2 = _interopRequireDefault(_getPrototype);

var _isObjectLike = __webpack_require__(62);
...
exports.toggleSquares = toggleSquares;
exports.newGrid = newGrid;
function toggleSquares(row, column) {
  return {
    type: 'TOGGLE',
    row: row,
    column: column
...
var _Gameboard = __webpack_require__(44);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        null,
        'Hello World',
        _react2.default.createElement(_Gameboard2.default, { height: '5', width: '5' })
      );
    }
  }]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(2);var invariant=__webpack_require__(4);var warning=__webpack_require__(6);var ExecutionEnvironment=__webpack_require__(13);var _assign=__webpack_require__(3);var emptyFunction=__webpack_require__(1);var EventListener=__webpack_require__(14);var getActiveElement=__webpack_require__(15);var shallowEqual=__webpack_require__(16);var containsNode=__webpack_require__(17);var focusNode=__webpack_require__(18);var emptyObject=__webpack_require__(5);var checkPropTypes=__webpack_require__(7);var hyphenateStyleName=__webpack_require__(40);var camelizeStyleName=__webpack_require__(42);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
var _Square = __webpack_require__(45);
...
var Gameboard = function (_React$Component) {
  ...
  function Gameboard(props) {
    ...
    console.log(_this.props.height, _this.props.width);
    _this.props.toNewGrid(_this.props.height, _this.props.width);
    return _this;
  }
  ...
  _createClass(Gameboard, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'board' },
        Array(parseInt(this.props.height)).fill('').map(function (row, y) {
          return _react2.default.createElement(
            'div',
            { className: 'row', key: y },
            Array(parseInt(_this2.props.width)).fill('').map(function (square, x) {
              var key = '' + x + y;
              return _react2.default.createElement(_Square2.default, { key: key, row: x, column: y });
            })
          );
        })
      );
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    toNewGrid: function toNewGrid(row, column) {
      return (0, _index.newGrid)(row, column);
    }
  };
};

Gameboard = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Gameboard);
  ...
  _createClass(Square, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', {
        className: 'square ' + this.state.hover + ' ' + this.props.grid[this.props.row][this.props.column],
        onMouseEnter: function onMouseEnter() {
          _this2.setState({ hover: 'hover' });
        },
        onMouseLeave: function onMouseLeave() {
          return _this2.setState({ hover: '' });
        },
        onClick: function onClick() {
          return _this2.props.toToggleSquares(_this2.props.row, _this2.props.column);
        } });
    }
  }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    toToggleSquares: function toToggleSquares(row, column) {
      return (0, _index.toggleSquares)(row, column);
    }
  };
};

Square = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Square);
...
var _mapStateToProps = __webpack_require__(70);

var _mapStateToProps2 = _interopRequireDefault(_mapStateToProps);

var _mergeProps = __webpack_require__(71);

var _mergeProps2 = _interopRequireDefault(_mergeProps);

var _selectorFactory = __webpack_require__(72);
...
var _getRawTag = __webpack_require__(58);

var _getRawTag2 = _interopRequireDefault(_getRawTag);

var _objectToString = __webpack_require__(59);
...
var _overArg = __webpack_require__(61);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(24), __webpack_require__(65)(module)))
...
var _verifySubselectors = __webpack_require__(73);
...
var _squareReducer = __webpack_require__(78);
...
var _sync = __webpack_require__(76);
...
var squareReducer = function squareReducer() {
  ...
  console.log('in square reducer', action.type, action.row, action.column);
  var newState = void 0;
  switch (action.type) {
    case 'NEW':
      newState = {};
      for (var i = 0; i < action.row; i++) {
        newState[i] = {};
        for (var j = 0; j < action.column; j++) {
          newState[i][j] = false;
        }
      }
      return newState;
    case 'TOGGLE':
      ...
      if (newState[action.row][action.column + 1]) {
